...
<body class="hold-transition skin-purple sidebar-mini">
	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			...
			<form action="${pageContext.request.contextPath}/springmvc/update"
				method="post">
					...
					<div class="row data-type">
						...
						<div class="col-md-4 data">
							<select class="form-control select2" style="width: 100%"
								...
								<option value="0" <c:if test="${product.productStatus==0}">selected</c:if> >无效</option>
								<option value="1" <c:if test="${product.productStatus==1}">selected</c:if>>有效</option>
							</select>
						</div>
